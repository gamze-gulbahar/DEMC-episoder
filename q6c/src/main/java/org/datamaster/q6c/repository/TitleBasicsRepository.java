package org.datamaster.q6c.repository;

import org.datamaster.q6c.entity.TitleBasics;
...
public interface TitleBasicsRepository extends JpaRepository<TitleBasics, String> {
    ...
    @Query(value = "SELECT primary_title, te.season_number, te.episode_number, tr.num_votes\n" +
            ...
            "      and primary_title=?1)\n" +
            "ORDER BY num_votes DESC LIMIT 5", nativeQuery = true)
